#!/bin/bash
#
# example:  ./vbng-setup-vxlan.sh eth1 10.30.2.2/24 10.30.2.1 10.50.1.2 5002 10.50.1.1 20.20.0.1 eth2 10.30.1.2/24 10.30.1.1 2500mbit
#
#
...
OspfTemplateFile="quagga-tmpl/ospfd-template.conf"
BgpTemplateFile="quagga-tmpl/bgpd-template.conf"
ZebraTemplateFile="quagga-tmpl/zebra-template.conf"
...
# quagga bgp provides this now
#ip route add $remotenet via $nexthop dev ${uplinkphy}
# TODO: quagga ospf needs to do this
